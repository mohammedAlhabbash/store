<x-HomeLayout :title="$product->name">
    <x-slot:breadcrumb>
        <!-- Start Breadcrumbs -->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <h3 class="price">{{ Currency::currencyFormat($product->price) }}
                                @if ($product->compare_price)
                                    <span>{{ Currency::currencyFormat($product->compare_price) }}</span>
                            </h3>
                            @endif
                            <p class="info-text">{{ $product->describtion }}</p>
                            <div class="row">
